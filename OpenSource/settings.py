...
class OllamaConfig:
    ...
    # Remote Ollama with basic auth (optional)
    username: str = field(default_factory=lambda: os.getenv("OLLAMA_USERNAME", ""))
    password: str = field(default_factory=lambda: os.getenv("OLLAMA_PASSWORD", ""))
